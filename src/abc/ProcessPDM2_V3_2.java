 ...
 */
public class ProcessPDM2_V3_2 {

    private static String process_file_name = "";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            File dir = new File("G:\\feiq-recv-files\\于鑫(305A3A0B5556)\\pdm");
            File dir_out = new File("G:\\feiq-recv-files\\于鑫(305A3A0B5556)\\pdm_out");
            for(File file : dir.listFiles() ) {

                String name = file.getName();
                process_file_name = file.getName();

                File file1 = new File(dir_out.getAbsolutePath() + File.separator + name.substring(0,name.indexOf(".")) + "_out.pdm");
                OutputStreamWriter osw = new OutputStreamWriter(new FileOutputStream(file1));
                BufferedWriter bw = new BufferedWriter(osw);

//                File file = new File(s + "basedb_base.pdm");
...
//                        }
    ...
    private static String processTableName(String line, int[] on_off) {
        ...
        switch (process_file_name) {
            case "basedb_midsch.pdm" :
                append_str = "t_thr_midsch_";
                break;

            case "company.pdm" :
                append_str = "t_thr_company_";
                break;
            case "edu.pdm" :
                append_str = "t_thr_edu_";
                break;
        }
...
//        System.out.println("------------>"+line +"   " +line.indexOf(">"));
        ...
        if(m.find()) {
            ...
            line = line.replace(substring,append_str+substring);
